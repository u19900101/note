    ...
    export default {
            ...
            this.contentEditor = new Vditor("vditor", {
                ...
                toolbar: [
                    ...
                    //自定义按钮
                    {
                        ...
                        click () {
                            vm.count = !vm.count
                            vm.contentEditor.setTheme(vm.count ? "light": "dark")
                        },
                    },
                    {
                        name: 'contentTheme',
                        ...
                        click () {
                            ...
                            vm.contentEditor.setTheme(vm.count ? "light": "dark",vm.contentTheme ? "light": "dark")
                        },
                    }
                    ],
                toolbarConfig: {
        ...
        watch: {
            '$store.state.currentNote'() {
                this.contentEditor.setValue(this.$store.state.currentNote.content)
                this.contentEditor.setTheme("light","dark","dark")
            }
        },
    }
</script>
