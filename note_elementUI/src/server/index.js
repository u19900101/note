...
export function updateImageTags(data) {
    return vm.post('/api/admin/imageTag/updateImageTags',data)
}

export function insertImageTag(data) {
...
export function moveFaceTo(data) {
    return vm.post('/api/admin/person/moveFaceTo',data)
}
...
export default {
    install(Vue) {
        Vue.prototype.https = {
            ...
            /*person*/
            getPersons,
            updatePersonName,mergePerson,deleteFace,moveFaceTo,
        }
    }
}
