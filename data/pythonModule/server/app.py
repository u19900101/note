...
def face_alignment(rgb_img):
    ...
    predicter_path =abs_pre + 'shape_predictor_68_face_landmarks.dat'
    ...
    for image in images:
        ...
        # 输出保存的临时对其后的人脸路径
        faceFileNameList += "f_" + str(image_cnt)+'.jpg,'
        cv2.imwrite(abs_pre + 'f_'+str(image_cnt)+'.jpg',cv_bgr_image)
    # f_1.jpg,f_2.jpg,
    return faceFileNameList
...
def get_data():
    ...
    # 假设有如下 URL
    # http://localhost:5000?imageUrl=http://lpgogo.top/img/2020-10-06/vip_(13)_c8.jpg
    imageUrl = data.get("imageUrl")
    imgpath = "../face/d/10.jpg"
    res = getFaceInfo(imgpath)
